                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?= $isi['diskon'] ?> %</td>
                                <td>Rp.<?= number_format($isi['harga_final']) ?></td>
                            ...
                            <table class="table table-striped bordered">
                                ...
                                <tr>
                                    ...
                                    <td><input type="number" placeholder="Harga Jual" required class="form-control"
                                            name="jual" id="harga_jual"></td>
                                </tr>
                                <tr>
                                    <td>Diskon</td>
                                    <td><input type="number" placeholder="0 %" required class="form-control"
                                            name="diskon" id="diskon"></td>
                                </tr>
                                <tr>
                                    <td>Final Price</td>
